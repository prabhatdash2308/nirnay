...
export async function GET(
  ...
  try {
    ...
    console.error("calendar-event GET unhandled:", error);
    return NextResponse.json(
...
export async function PATCH(
  ...
  try {
    ...
    const parsed = parseOrError(calendarEventUpdateSchema, body);
    ...
    console.error("calendar-event PATCH unhandled:", error);
    return NextResponse.json(
      { error: "Internal server error." },
      { status: 500 },
    );
...
export async function DELETE(
  ...
  try {
    ...
    console.error("calendar-event DELETE unhandled:", error);
    return NextResponse.json(
      { error: "Internal server error." },
      { status: 500 },
    );
